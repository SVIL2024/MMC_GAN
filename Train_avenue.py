...
def MNADTrain():
    ...
    parser.add_argument('--dataset_path', type=str, default='E:\\DMAD-master\\DMAD-PDM\\data\\datasets\\',
    ...
    for epoch in range(args.epochs):
        ...
        print(
            'With {} epochs, auc score is: {}, best score is: {}'.format(epoch + 1, score, early_stop['best_eval_auc']))
