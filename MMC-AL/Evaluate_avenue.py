...
from utils import *
import glob
from model.final_future_prediction_ped2 import convAE_Unet_Sspcab
import argparse
...
def MNADEval(model=None):
    ...
    parser.add_argument('--model_dir', type=str,  default='./modelzoo/new_avenue.pth', help='directory of model')
    ...
    # Loading dataset  这里别忘记传入 dataset_type=args.dataset_type
